...
{
    /// <inheritdoc />
    public partial class Basic_Elements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeaturedServicesID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeaturedServices", x => x.FeaturedServicesID);
                    table.ForeignKey(
                        name: "FK_FeaturedServices_ServiceCategories_ServiceCategoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeaturedServices_ServiceCategoryID",
